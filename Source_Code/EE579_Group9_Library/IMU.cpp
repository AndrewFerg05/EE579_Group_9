...
float G_offset[3] = {30.4, 60.2, 47.3};

// Accelerometer
float A_B[3] = {-1113.01 , -1060.22 , 470.38};
float A_Ainv[3][3] = {
{ 0.05241 , -0.00084 , -0.00014 },
{ -0.00084 , 0.06071 , 0.00048 },
{ -0.00014 , 0.00048 , 0.06213 }};
// Magnetometer
float M_B[3] = {-12.91 , 282.47 , -107.06};

float M_Ainv[3][3] = {
{ 3.48821 , 0.12677 , 0.2629 },
{ 0.12677 , 3.82034 , 0.09901 },
{ 0.2629 , 0.09901 , 2.84769 }};
