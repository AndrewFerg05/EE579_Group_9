...
float G_offset[3] = {8.9, 60.3, 51.6, };


    //Accelerometer
float A_B[3] =  { 1520.18, -1261.37, 132.02};
float A_Ainv[3][3] = {
{ 0.0577 , 0.00073 , 0.00296 },
{ 0.00073 , 0.06286 , -0.00074 },
{ 0.00296 , -0.00074 , 0.06034 }};

    //Magnetometer
float M_B[3] =  {-13.72,230.86, -41.14};

float M_Ainv[3][3] = {
{ 4.36652 , -0.03022 , -0.08794 },
{ -0.03022 , 4.11069 , 0.00253 },
{ -0.08794 , 0.00253 , 3.80538 }};
